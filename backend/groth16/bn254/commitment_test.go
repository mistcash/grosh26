	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ok := assert.NotPanics(t, func() {
				err = bn254groth16.Verify(proof, vk, public)
