...
func NewPolyRingChecker[T FieldParams](api frontend.API) *PolyRingChecker[T] {
	var fp T
...
func (prc *PolyRingChecker[T]) Field() *Field[T] {
	return prc.f
}
...
// product.
func (prc *PolyRingChecker[T]) isStrictZero(e *Element[T]) bool {
