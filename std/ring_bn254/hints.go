...
// The two hints below are gnark's, and unexported. Their maths -- inverting an
// 𝔽p¹² element, and finding the residue witness of a pairing check -- is not
// something to keep a second copy of, so they are picked out of the exported
// hint lists by name instead. Both are registered with the solver by gnark's
// own package init.
var (
